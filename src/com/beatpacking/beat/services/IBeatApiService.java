...
static final int TRANSACTION_setHideable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_isHideable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
}
